...
//int AnalogInputObject::isPropertyReadready(BacnetPropertyNS::Identifier propertyId)
//{
...
//Bacnet::BacnetDataInterface *AnalogInputObject::propertyReadInstantly(BacnetPropertyNS::Identifier propId, quint32 arrayIdx, Bacnet::Error *error)
//{
//    Q_CHECK_PTR(error);
...
//const QList<BacnetPropertyNS::Identifier> &AnalogInputObject::covProperties()
//{
//    static QList<BacnetPropertyNS::Identifier> identifiers =
//            QList<BacnetPropertyNS::Identifier>() << BacnetProperty::PresentValue << BacnetProperty::StatusFlags;
//    return identifiers;
//}

//QVariant::Type AnalogInputObject::variantTypeForProperty_helper(BacnetPropertyNS::Identifier propertyId)
//{
//    switch (propertyId)
//    {
...
//Bacnet::BacnetDataInterface *AnalogInputObject::createBacnetTypeForProperty_helper(BacnetPropertyNS::Identifier propertyId, quint32 arrayIdx)
//{
