...
namespace Bacnet
{
    ...
    typedef quint32 ObjIdNum;
    ObjIdNum objIdToNum(const ObjectIdStruct &objId);
    const ObjectIdStruct &invalidObjectId();
    ObjIdNum invalidObjIdNum();
    ObjectIdStruct numToObjId(ObjIdNum numObjId);
